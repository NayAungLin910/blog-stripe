<x-admin-layout>
    ...
    <section class="mx-6">
        <div class="p-8">
            <x-form action="{{ route('admin.tags.update', ['tag' => $tag]) }}" method="PUT" has-files>
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <x-form.textarea id="description" class="block w-full mt-1" name="description" required >{{ $tag->description() }}</x-form.textarea>
