<div class="flex flex-wrap gap-3">
    ...
    {{-- Facebook --}}
    <x-buttons.social href="https://www.facebook.com/sharer.php?u={{ $url }}" target="_blank">
        <x-fab-facebook-f class="w-5 h-5" />
    </x-buttons.social>

    {{-- Twitter --}}
    <x-buttons.social href="https://www.instagram.com/intent/tweet?url={{ $url }}text={{ $post->title() }}" target="_blank">
